(function($) {
  ...
  var modal = {
    ...
    transition: function(el, action, options, callback) {
      ...
      switch (options.type) {
        case 'fade':
          action == 'show' ? el.fadeIn(options.speed, callback) : el.fadeOut(
      ...
      var o = $.extend(true, {
        ...
        beforeSend: function() {
          D.body.html(D.preloader.tpl).
              css('verticalAlign', D.preloader.verticalAlign === undefined
                  ? D.verticalAlign
        ...
        error: function() {
          ...
          if (fn_error == undefined) {
            ...
            $('.modal2-error', D.body).html(D.errors.ajaxUnsuccessfulLoad);
      ...
      if ($.isFunction(this)) {
        ...
        return this.each(function() {
          ...
          modal.transition(D.container.block, 'hide',
              modals.length > 1 ? {type: 'none'} : D.closeEffect, function() {
                ...
                if (!$('.modal2-container').length) {
                  if (D.wrap.data('modal2Overflow'))
                    D.wrap.css('overflow-y', D.wrap.data('modal2Overflow'));
